...
/**
 * Created by Chetan on 2019-10-13.
 */

/**
 * Class responsible for holding all the navigation related information
 * It makes sure the navigation is smooth
 */
class Navigator {
